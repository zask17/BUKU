                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pdf.sertifikat') }}" method="POST" target="previewFrame">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="nomor" class="form-control" placeholder="Contoh: 3353/B/UN3..." required>
                        </div>
                        <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="jabatan" class="form-control" placeholder="Contoh: Peserta / Pemateri" required>
                        </div>
                        <div class="form-group mb-2">
                            <label class="small fw-bold">Nama Acara</label>
                            <textarea name="acara" class="form-control" rows="3" placeholder="Masukkan nama agenda acara secara lengkap" required></textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label class="small fw-bold">Tanggal Acara</label>
                            <input type="text" name="tanggal" class="form-control" placeholder="Contoh: 25 Februari 2026" required>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" name="nip_dekan" class="form-control mb-2" placeholder="NIP Dekan" required>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-6">
                                <input type="text" name="koordinator" class="form-control mb-2" placeholder="Nama Koorprodi" required>
                            </div>
                            <div class="col-6">
                                <input type="text" name="nik_koor" class="form-control mb-2" placeholder="NIK Koorprodi" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" name="nik_ketua" class="form-control mb-2" placeholder="NIK Ketua" required>
                            </div>
                        </div>
